    ...
    <>
      <IdentityPageMobileWrapper>
        <div className="content">
          ...
          <p>
            모두가 1에 가지는 의미가 다르지만 경북대학교 디자인학과 졸업생들이day 하루가 될 수 있고, 1step 한 단계가 될
            수도 있으며, 1st 한 분야의 최고가 될 수도 있습니다. 모두가 1에 가지는 의미가 다르지만 경북대학교 디자인학과
            졸업생들이 하나를 추구하며 만든 ‘우리의 1’은그 뜻을 함께 하기에 하나가 될 수 있었습니다.
          </p>
          <p>
      ...
      <IdentityPagePCWrapper>
        ...
        <Row className="description-wrapper">
          <p className="description">
            모두가 1에 가지는 의미가 다르지만 경북대학교 디자인학과 졸업생들이day 하루가 될 수 있고, 1step 한 단계가 될
            수도 있으며, 1st 한 분야의 최고가 될 수도 있습니다.
            <br />
            모두가 1에 가지는 의미가 다르지만 경북대학교 디자인학과 졸업생들이 하나를 추구하며 만든 ‘우리의 1’은 그 뜻을
            함께 하기에 하나가 될 수 있었습니다.
          </p>
          <p className="description">
