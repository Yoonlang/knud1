...
export const TEAMS_DATA: TeamDataInterface[] = [
  {
    name: 'Planning Team',
    imgSrc: '/assets/teams/planning_team.png',
    leader: '조은지',
    members: ['곽나영', '송예빈', '양준녕', '이원준', '이지안'],
  },
  {
    name: 'Digital Media Team',
    imgSrc: '/assets/teams/digital media_team.png',
    leader: '곽나영',
    members: ['김현주', '오지현', '이예림', '장수현', '정다은', '정유나'],
  },
  {
    name: ' Editorial Team',
    imgSrc: '/assets/teams/editorial_team.png',
    leader: '이원준',
    members: ['김미현', '송희주', '이연주', '진수별'],
  },
  {
    name: ' Exhibition Team',
    imgSrc: '/assets/teams/exhibition team.png',
    leader: '이지안',
    members: ['김의정', '서다은', '이아림', '윤지현', '한예리', '홍이도'],
  },
  {
    name: 'Graphic Team',
    imgSrc: '/assets/teams/graphic_team.png',
    leader: '양준녕',
